...
## Why do we need it
You need reusable templates for reliable deployments.
...
- Read-only layered image.
- Docker Hub and custom builds.
- pull/images/inspect commands.
- Layer diagram.
...
## Quick Revision
- 01 Images is easier when you think in small building blocks.
