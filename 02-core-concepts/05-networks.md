...
## What is it
Docker networks connect containers so they can communicate safely.

## Why do we need it
By default, containers need explicit network setup to talk cleanly.
...
## Real life analogy
Apartment building hallways and door numbers.
...
## Quick Revision
- 05 Networks is easier when you think in small building blocks.
