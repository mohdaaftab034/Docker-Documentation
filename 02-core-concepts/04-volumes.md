...
## What is it
Volumes are persistent storage managed by Docker outside container lifecycle.

## Why do we need it
Container filesystem changes can be lost when container is removed.
...
## Real life analogy
USB drive you can plug into different computers.
...
## Quick Revision
- 04 Volumes is easier when you think in small building blocks.
