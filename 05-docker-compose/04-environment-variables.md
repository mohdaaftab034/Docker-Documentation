...
## What is it
Environment variables are key-value settings provided to containers at runtime.

## Why do we need it
You should separate config from code and avoid hardcoding values.
...
## Real life analogy
Sticky notes with settings for each room.
...
## Quick Revision
- 04 Environment Variables is easier when you think in small building blocks.
