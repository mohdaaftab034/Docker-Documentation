# 03 Services Networks Volumes

This part trips everyone up at first, do not worry. We will go slow, and we will connect every idea to real work.

## What is it
Compose services define containers and how they connect and store data.

## Why do we need it
Most real apps need multiple services with shared rules.
...
## Real life analogy
Neighborhood with roads and storage units.
...
## Quick Revision
- 03 Services Networks Volumes is easier when you think in small building blocks.
