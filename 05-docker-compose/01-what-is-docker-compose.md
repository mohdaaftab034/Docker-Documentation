...
## What is it
Docker Compose runs multi-container apps using one YAML file.

## Why do we need it
Starting many containers manually is repetitive and error-prone.
...
## Real life analogy
Band conductor controls all musicians.
...
## Quick Revision
- 01 What Is Docker Compose is easier when you think in small building blocks.
