...
## What is it
Compose commands create, inspect, and manage all services in an app stack.

## Why do we need it
You need one command set for full-stack local workflows.
...
## Real life analogy
Remote control for all appliances at once.
...
- up down ps logs exec build restart stop pull commands.
...
## Quick Revision
- 05 Compose Commands is easier when you think in small building blocks.
