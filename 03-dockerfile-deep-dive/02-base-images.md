...
## What is it
A base image is the starting point for your image build.

## Why do we need it
Your base image affects security, size, and compatibility.
...
## Quick Revision
- 02 Base Images is easier when you think in small building blocks.
