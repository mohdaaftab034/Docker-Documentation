...
## What is it
Multistage builds use separate stages for building and running, producing smaller runtime images.

## Why do we need it
Build tools in production images increase size and risk.
...
## Real life analogy
Workshop and showroom are separate rooms.
...
## Quick Revision
- 04 Multistage Builds is easier when you think in small building blocks.
