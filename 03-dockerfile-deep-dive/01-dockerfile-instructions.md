# 01 Dockerfile Instructions

This part trips everyone up at first, do not worry. We will go slow, and we will connect every idea to real work.

## What is it
Dockerfile instructions define how the build system creates each layer.

## Why do we need it
Using wrong instruction order causes large images and slow builds.
...
## Real life analogy
Building a sandwich layer by layer.
...
## Quick Revision
- 01 Dockerfile Instructions is easier when you think in small building blocks.
