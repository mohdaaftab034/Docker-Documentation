...
## What is it
We are building a Flask API image and running it with Gunicorn for production.

## Why do we need it
Python app behavior differs by package versions and local virtual environments.
...
# Run Flask API
docker run --name flask-api --publish 5000:5000 --detach flask-api:1.0.0
...
Common fix: pin dependency versions in requirements.txt and rebuild without cache.
