...
## What is it
Bridge is Docker's default private network driver on a host.

## Why do we need it
Containers need controlled communication and outbound internet.
...
## Real life analogy
Local street network inside one neighborhood.
...
## Quick Revision
- 01 Bridge Network is easier when you think in small building blocks.
