...
## What is it
None network gives a container no network interface except loopback.

## Why do we need it
For strict isolation and file-only batch tasks.
...
## Real life analogy
Locked study room with no internet.
...
## Quick Revision
- 03 None Network is easier when you think in small building blocks.
