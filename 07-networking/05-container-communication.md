# 05 Container Communication

This part trips everyone up at first, do not worry. We will go slow, and we will connect every idea to real work.

## What is it
Containers communicate over shared networks using names and ports.

## Why do we need it
Most microservices rely on service-to-service communication.
...
## Real life analogy
Calling neighbors by apartment number.
...
## Quick Revision
- 05 Container Communication is easier when you think in small building blocks.
