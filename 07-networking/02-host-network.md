...
## What is it
Host network mode lets container use host network stack directly.

## Why do we need it
Useful for low-latency workloads where port mapping overhead is unwanted.
...
## Real life analogy
Using the same phone line as the house owner.
...
## Quick Revision
- 02 Host Network is easier when you think in small building blocks.
