...
## What is it
Custom bridge networks provide scoped communication and DNS by container name.

## Why do we need it
Default bridge can be noisy in larger local stacks.
...
## Real life analogy
Private office floor with named rooms.
...
## Quick Revision
- 04 Custom Networks is easier when you think in small building blocks.
