# 04 Automated Deployments

This part trips everyone up at first, do not worry. We will go slow, and we will connect every idea to real work.

## What is it
Automated deployments update containers on servers with minimal manual effort.

## Why do we need it
Manual SSH deployments are slow and error-prone.
...
## Real life analogy
Scheduled train arrivals with automatic platform updates.
...
## Quick Revision
- 04 Automated Deployments is easier when you think in small building blocks.
