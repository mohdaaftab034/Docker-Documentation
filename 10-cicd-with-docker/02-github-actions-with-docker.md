# 02 GitHub Actions with Docker

This part trips everyone up at first, do not worry. We will go slow, and we will connect every idea to real work.

## What is it
GitHub Actions can build and push Docker images automatically.

## Why do we need it
Automation removes manual release errors.
...
## Real life analogy
Auto conveyor belt from code commit to package shelf.
...
## Quick Revision
- 02 GitHub Actions with Docker is easier when you think in small building blocks.
