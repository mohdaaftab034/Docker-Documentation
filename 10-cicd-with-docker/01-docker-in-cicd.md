...
## What is it
Docker makes CI/CD pipelines reproducible across runners and environments.

## Why do we need it
Pipelines fail when tools differ between stages.
...
## Real life analogy
Same lunchbox recipe in every school branch.
...
## Quick Revision
- 01 Docker in CI/CD is easier when you think in small building blocks.
