...
## What is it
Resource limits cap CPU and memory a container can consume.

## Why do we need it
One noisy container can crash a whole host without limits.
...
## Real life analogy
Budget envelope for each department.
...
## Quick Revision
- 05 Resource Limits is easier when you think in small building blocks.
