...
## What is it
Health checks are automated tests that mark containers healthy or unhealthy.

## Why do we need it
Running does not always mean ready; health checks prevent bad traffic routing.
...
## Real life analogy
Coach checking players are fit before match.
...
## Quick Revision
- 04 Health Checks is easier when you think in small building blocks.
