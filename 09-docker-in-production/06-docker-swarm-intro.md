# 06 Docker Swarm Intro

This part trips everyone up at first, do not worry. We will go slow, and we will connect every idea to real work.

## What is it
Docker Swarm is Docker's built-in orchestration mode for clustered hosts.

## Why do we need it
Single-host Docker is not enough for high availability at scale.
...
## Real life analogy
Team manager assigning shifts across stores.
...
## Quick Revision
- 06 Docker Swarm Intro is easier when you think in small building blocks.
