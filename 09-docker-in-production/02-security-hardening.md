...
## What is it
Security hardening reduces attack surface in containerized apps.

## Why do we need it
Default container settings are often too permissive for production.
...
## Real life analogy
Locking all doors, not just front door.
...
## Quick Revision
- 02 Security Hardening is easier when you think in small building blocks.
