...
## What is it
Docker uses a client-server model where the CLI talks to the Docker daemon to build and run containers.

## Why do we need it
Understanding architecture makes debugging much easier.
...
## Real life analogy
Waiter and kitchen analogy: CLI is waiter, daemon is kitchen.
...
## Quick Revision
- 04 How Docker Works is easier when you think in small building blocks.
