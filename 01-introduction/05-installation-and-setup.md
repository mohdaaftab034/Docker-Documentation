...
## What is it
Installation means setting up Docker Desktop or Docker Engine and confirming it can run containers.

## Why do we need it
Most beginner errors are setup problems, so verification matters.
...
## Real life analogy
Installing a new oven before cooking.
...
- Run hello-world and explain output.
- Dashboard tour.
...
## Quick Revision
- 05 Installation and Setup is easier when you think in small building blocks.
