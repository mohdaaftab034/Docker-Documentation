...
## What is it
Docker containers share the host kernel, while VMs run a full guest operating system.

## Why do we need it
Choosing wrong isolation tech can waste resources or hurt security goals.
...
## Real life analogy
VM is a full house inside a building; container is a furnished room with shared utilities.
...
- Size/startup/performance table.
...
## Quick Revision
- 03 Docker vs Virtual Machines is easier when you think in small building blocks.
