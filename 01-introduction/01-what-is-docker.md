...
## What is it
Docker is a tool that packages your app and everything it needs into a portable unit called an image.

## Why do we need it
Before Docker, teams often hit the 'works on my machine' problem. Docker gives consistency, portability, and isolation.
...
## Real life analogy
Shipping container analogy: same container shape travels by truck, ship, or train without repacking.
...
## Quick Revision
- 01 What Is Docker is easier when you think in small building blocks.
