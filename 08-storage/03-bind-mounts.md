...
## What is it
Bind mounts map an exact host path into a container.

## Why do we need it
Great for development workflows with live code edits.
...
## Quick Revision
- 03 Bind Mounts is easier when you think in small building blocks.
