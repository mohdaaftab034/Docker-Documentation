...
## What is it
Tmpfs mounts store data in memory and remove it when container stops.

## Why do we need it
Useful for temporary sensitive data and fast scratch space.
...
## Real life analogy
Whiteboard notes erased after class.
...
## Quick Revision
- 04 Tmpfs Mounts is easier when you think in small building blocks.
