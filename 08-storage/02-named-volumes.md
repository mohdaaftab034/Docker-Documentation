...
## What is it
Named volumes are reusable persistent storage units managed by Docker.

## Why do we need it
Databases and uploads must survive container recreation.
...
## Real life analogy
Storage box with a label you can reuse.
...
## Quick Revision
- 02 Named Volumes is easier when you think in small building blocks.
